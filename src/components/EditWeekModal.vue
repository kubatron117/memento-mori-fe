<template>
  ...
  >
    ...
    <div v-if="isEditable">
      <div class="mb-4">
        <!-- Upravená text area s bílým pozadím a černým textem -->
      ...
      <div class="flex flex-col gap-4 mt-4">
        ...
        >
          ...
          <!-- Použití vlastní komponenty pro hodnocení s pomocnými funkcemi -->
          <RatingStars
...
// Pole s informacemi o hodnoceních – nyní jen s klíči a popisky
const ratingFields = [
